...
The navigation syntax is recursive, which supports nested navigation groups. You do not need to include `.mdx` in page names.
...
Place MDX files in folders and update the corresponding paths in `docs.json`.
