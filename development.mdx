...
Use IDE extensions to recognize and format MDX. If you are using VSCode, consider the [MDX VSCode extension](https://marketplace.visualstudio.com/items?itemName=unifiedjs.vscode-mdx) for syntax highlighting and [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) for formatting.
...
For CLI release details, see the [CLI changelog](https://www.npmjs.com/package/mintlify?activeTab=versions).
